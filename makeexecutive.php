...
$id = $_SESSION['sac_id'];
    ...
    $updateuser = "UPDATE `user` SET `rights`='Executive' WHERE id = $newid";
    $process = $db->query($updateuser);

    $registersignin = "INSERT INTO systemrecord (user, object, record) values ($id, $newid, 'Assign Executive access')";
