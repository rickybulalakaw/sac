...
checkaccessrights();
    ...
    $updateuser = "UPDATE `user` SET `rights`='ITSupport' WHERE id = $newid";
    $process = $db->query($updateuser);

    $registersignin = "INSERT INTO systemrecord (user, object, record) values ($id, $newid, 'Assign IT Support access')";
